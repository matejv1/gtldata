...
Timeline.OriginalEventPainter.prototype.paintCustomEvent = function(evt, metrics, theme, highlightIndex) {
...
Timeline.OriginalEventPainter.prototype._onHoverEvent = function(icon, domEvt, evt) {
    var c = SimileAjax.DOM.getPageCoordinates(icon);
