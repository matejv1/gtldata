...
Timeline._Band = function(timeline, bandInfo, index) {
    ...
    if (mouseWheel === 'zoom' || mouseWheel === 'scroll' || this._zoomSteps) {
        ...
        if (SimileAjax.Platform.browser.isFirefox) {
			...
			//SimileAjax.DOM.registerEventWithObject(this._div, "DOMMouseScroll", this, "_onScrollBasic");
        } else {
...
Timeline._Band.prototype._onMouseScroll = function(innerFrame, evt, target) {
  ...
  if (!this._lastScrollTime || ((now - this._lastScrollTime) > 50)) {
    ...
    console.log("scroll - " + now + " : " + this._lastScrollTime + " - " + evt.wheelDelta + " - " + evt.detail);
...
Timeline._Band.prototype._onScrollBasic = function(innerFrame, evt, target) {
